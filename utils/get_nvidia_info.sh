...
echo -e "id=${GPU_INDEX} | ${GPU_NAME} [Discrete] @ CPU(${CPU_COLOR}${GPU_UTILIZATION}%${COLOR_RESET}) MEM(${MEM_COLOR}${MEM_UTILIZATION}%${COLOR_RESET}) (${TEMP_COLOR}${GPU_TEMPERATURE}.0°C${COLOR_RESET})"
